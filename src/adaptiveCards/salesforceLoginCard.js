        ...
        actions: [
            {
                ...
                url: `https://login.salesforce.com/services/oauth2/authorize?response_type=code&client_id=${salesforceClientId}&redirect_uri=${salesforceRedirectUri}&scope=${salesforceOauthScope}&state=${authState}`,
                style: "positive"
            },
            {
                type: "Action.OpenUrl",
